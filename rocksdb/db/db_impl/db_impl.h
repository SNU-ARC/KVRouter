...
extern float rocks_max_[16];
extern float kv_max_[16];
...
class DBImpl : public DB {
 ...
 protected:
  ...
  // DU
  bool CheckBatchSizeForKV(WriteThread::Writer * w); 

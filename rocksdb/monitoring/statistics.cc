...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {KV_L0_HIT, "rocksdb.kv_l0.hit"},
    {KV_L0_MISS, "rocksdb.kv_l0.miss"},
    {KV_LAST_HIT, "rocksdb.kv_last.hit"},
    {KV_PREFETCH_HIT, "rocksdb.kv_prefetch.hit"},
    {KV_PREFETCH_MISS, "rocksdb.kv_prefetch.miss"},
    {KV_LAST_PREFETCH_HIT, "rocksdb.kv_last_prefetch.hit"},
    {KV_LAST_PREFETCH_MISS, "rocksdb.kv_last_prefetch.miss"},
    ...
    {HIT_L0, "rocksdb.hit_l0"},
    {HIT_L1, "rocksdb.hit_l1"},
    {HIT_L2, "rocksdb.hit_l2"},
    {HIT_L3, "rocksdb.hit_l3"},
    {HIT_L4, "rocksdb.hit_l4"},
    {HIT_L5, "rocksdb.hit_l5"},
...
const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap = {
    ...
    {KV_L0_INDEX, "rocksdb.kv_l0_index.micros"},
    {KV_L0, "rocksdb.kv_l0.micros"},
    {KV_L0_SSD, "rocksdb.kv_l0_ssd.micros"},
    {KV_LAST_WAIT, "rocksdb.kv_last_wait.micros"},
    {KV_LAST, "rocksdb.kv_last.micros"},
    {KV_WRITE_TO_KVSSD, "rocksdb.kv_write_to_kvssd.micros"},
    {KV_CHECK_KVSSD, "rocksdb.kv_check_kvssd.micros"},
    //{KV_WRITE_INDEX, "rocksdb.kv_index.micros"},
    //{KV_WRITE, "rocksdb.kv_write.micros"},

    {KV_FLUSH_INDEX, "rocksdb.kv_flush_index.micros"},
    {KV_FLUSH_WRITE, "rocksdb.kv_flush_write.micros"},
    {KV_FLUSH_INFO, "rocksdb.kv_flush_info.micros"},

    {KV_COMPACTION_COMPARE, "rocksdb.kv_compaction_compare.micros"},
    {KV_COMPACTION_WRITE, "rocksdb.kv_compaction_write.micros"},
    {KV_COMPACTION_INDEX, "rocksdb.kv_compaction_index.micros"},
    {KV_COMPACTION_ASYNC, "rocksdb.kv_compaction_async.micros"},
    {KV_COMPACTION_FINISH, "rocksdb.kv_compaction_finish.micros"},
    {KV_COMPACTION_NORMAL, "rocksdb.kv_compaction_normal.micros"},
    {KV_COMPACTION_KVSSD, "rocksdb.kv_compaction_kvssd.micros"},
};
...
std::string StatisticsImpl::ToString() const {
  ...
  for (const auto& h : HistogramsNameMap) {
    ...
    if (hData.count == 0) {
        ...
        snprintf(buffer, kTmpStrBufferSize,
                 "%s P50 : %f P95 : %f P99 : %f P100 : %f COUNT : %" PRIu64
                 " SUM : %" PRIu64 " Average : %f\n",
                 h.second.c_str(), hData.median, hData.percentile95,
                 hData.percentile99, hData.max, hData.count, hData.sum, (float) hData.sum/hData.count);
    }
